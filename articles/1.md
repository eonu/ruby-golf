...
- [Eliminate whitespace](#1)
- [Eliminate parentheses](#2)
- [Shorten variable names](#3)
- [Better control flow and method returns](#4)
- [Operator precedence](#5)

---

## Eliminate whitespace <a name="1"></a>
...
However, this doesn't work with variables, constants and methods followed or preceded by reserved Ruby words like `if`. What if we try to remove the space between `if` and `C`, or what if we replace `C` with an integer?
...
However, it works with strings, symbols and arrays (and most of the other literals excluding the numbers, although this also changes depending on precedence):
...
## Eliminate parentheses <a name="2"></a>
...
## Shorten variable names <a name="3"></a>
...
## Better control flow and method returns <a name="4"></a>

Ruby has a number of useful features for optimising your control flow and method returns - namely the ternary operator and automatic returning of the last evaluated expression.
...
## Operator precedence <a name="5"></a>
