...
- [Don't use `Range#member?` or `Range#include?` to check for range membership](#don't_use_range#member?_or_range#include?_to_check_for_range_membership)
...
- [Eliminate square brackets for array assignment](#eliminate_square_brackets_for_array_assignment)
