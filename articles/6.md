...
*Techniques for array and range manipulation and optimisation, and understanding the neat Ruby splat operator .*

------

- [Use `%` for declaring arrays of strings or symbols](#use_%_for_declaring_arrays_of_strings_or_symbols)
...
- [Don't use `Range#member?` or `Range#include?` to check for range membership](#don't_use_range#member?_or_range#include?_ to_check_for_range_membership)
...
- [Use `[]` instead of `Array#new` for array initialization](#use_[]_instead_of_array#new for array initialization)
- [Use the splat operator `*` to declare singleton arrays](#use_the_splat_operator_*_to_declare_singleton_arrays)
- [Eliminate square brackets for array assignment](#eliminate_square brackets_for_array_assignment)
...
## Use `%` for declaring arrays of strings or symbols <a name="use_%_for_declaring_arrays_of_strings_or_symbols"></a>
...
## Don't use `Range#member?` or `Range#include?` to check for range membership <a name="don't_use_range#member?_or_range#include?_ to_check_for_range_membership"></a>
...
## Use `[]` instead of `Array#new` for array initialization <a name="use_[]_instead_of_array#new for array initialization"></a>
...
## Eliminate square brackets for array assignment <a name="eliminate_square brackets_for_array_assignment"></a>
