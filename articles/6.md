...
- [Use `[]` instead of `Array#new` for array initialization](#use_brackets_instead_of_array#new_for_array_initialization)
...
## Don't use `Range#member?` or `Range#include?` to check for range membership <a name="don't_use_range#member_or_range#include_ to_check_for_range_membership"></a>
...
## Use `[]` instead of `Array#new` for array initialization <a name="use_brackets_instead_of_array#new for array initialization"></a>
